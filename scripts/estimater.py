...
class FoundationPose:
  def __init__(self, model_pts, model_normals, symmetry_tfs=None, mesh=None, scorer:ScorePredictor=None, refiner:PoseRefinePredictor=None, glctx=None, debug=0, debug_dir='/home/bowen/debug/novel_pose_debug/'):
    ...
    self.make_rotation_grid(min_n_views=40, inplane_step=90)
  ...
  def register(self, K, rgb, depth, ob_mask, ob_id=None, glctx=None, iteration=5):
    ...
    print(f"Context initialization time: {context_time:.6f} seconds")
    ...
    print(f"Depth processing time: {depth_processing_time:.6f} seconds")
    ...
    print(f"Debug output time: {debug_time:.6f} seconds")
    ...
    pose_generation_time = time.time() - start_time
    print(f"Pose generation time: {pose_generation_time:.6f} seconds")
    ...
    print(f"Pose optimization time: {optimization_time:.6f} seconds")
    ...
    print(f"Scoring time: {scoring_time:.6f} seconds")
