...
public:
    ...
    ~LayerNormalizationPlugin() override;
...
public:
    ...
    ~LayerNormalizationPluginCreator() override;

    LayerNormalizationPluginCreator(const LayerNormalizationPluginCreator& /*other*/) = delete;
    LayerNormalizationPluginCreator& operator=(const LayerNormalizationPluginCreator& /*other*/) = delete;
    LayerNormalizationPluginCreator(LayerNormalizationPluginCreator&& /*other*/) noexcept = delete;
    LayerNormalizationPluginCreator& operator=(LayerNormalizationPluginCreator&& /*other*/) noexcept = delete;
